...
export class MateriaBancoDadosComponent implements OnInit {
  audio: any;

  constructor(private router: Router) {}

  ngOnInit(): void {
    this.audio = new Audio('../../../assets/som/medieval-4.mp3');
  ...
  questions = [
    {
      ...
      options: [
        {
          label: 'Um sistema de gerenciamento de banco de dados relacional.',
          isCorrect: false,
        },
        {
          label: 'Um banco de dados NoSQL orientado a documentos.',
          isCorrect: true,
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          label:
            'Um registro de dados no MongoDB, representado em formato BSON.',
          isCorrect: true,
        },
      ],
    },
    ...
    },
    {
      ...
      options: [
        ...
        {
          label:
            'Uma técnica para dividir grandes conjuntos de dados em várias máquinas.',
          isCorrect: true,
        },
        {
          label: 'Uma linguagem de programação usada no MongoDB.',
          isCorrect: false,
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          label: 'Uma estrutura de dados usada para acelerar consultas.',
          isCorrect: true,
        },
    ...
    },
    {
      ...
      options: [
        {
          label: 'Sempre, o MongoDB é superior em todos os casos.',
          isCorrect: false,
        },
        {
          label: 'Quando você tem dados altamente estruturados.',
          isCorrect: false,
        },
        {
          label:
            'Quando você precisa de flexibilidade para armazenar dados não estruturados ou semiestruturados.',
          isCorrect: true,
        },
      ],
    },
    {
      ...
      options: [
        {
          label: 'Uma técnica para dividir dados em várias máquinas.',
          isCorrect: false,
        },
        {
          label:
            'Um processo de cópia de dados de um servidor para outro para alta disponibilidade.',
          isCorrect: true,
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          label: 'Usando a linguagem de consulta própria do MongoDB (MQL).',
          isCorrect: true,
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          label:
            'O formato de representação binária dos documentos no MongoDB.',
          isCorrect: true,
        },
    ...
    },
    {
      ...
      options: [
        {
          label: 'O MongoDB não oferece suporte a transações.',
          isCorrect: false,
        },
        {
          label: 'Ele suporta transações semelhantes ao SQL.',
          isCorrect: true,
        },
        {
          label:
            'As transações no MongoDB são tratadas por um servidor de terceiros.',
          isCorrect: false,
        },
      ],
    },
    {
      ...
      options: [
        {
          label: 'Uma técnica para compactar documentos no banco de dados.',
          isCorrect: false,
        },
        {
          label:
            'Uma estrutura para realizar operações de agregação e transformação de dados.',
          isCorrect: true,
        },
        {
          label: 'Um módulo para criptografar dados no MongoDB.',
          isCorrect: false,
        },
      ],
    },
